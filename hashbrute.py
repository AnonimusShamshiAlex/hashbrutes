...
def check_office(password: str, params: dict) -> bool:
    """Упрощённая проверка MS Office (можно улучшить)"""
...
def crack_hash(hash_input: str, wordlist_file: str = "passwords.TXT") -> None:
    ...
    """
    print("\n" + "="*60)
    print("         УНИВЕРСАЛЬНЫЙ КРАКЕР ХЭШЕЙ v2.0")
    print("="*60)
    ...
    if hash_type in ["md5", "sha1", "sha256", "sha512", "crc32", "ntlm"]:
...
def interactive_mode():
    ...
    print("\n" + "="*60)
    print("         УНИВЕРСАЛЬНЫЙ КРАКЕР ХЭШЕЙ")
    print("="*60)
